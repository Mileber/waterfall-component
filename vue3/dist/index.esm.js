import { defineComponent, nextTick, openBlock, createElementBlock, normalizeStyle, createElementVNode, renderSlot, Fragment, renderList, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", {
    class: "wf-container",
    style: normalizeStyle({ width: _ctx.widthStyle, height: _ctx.heightStyle })
  }, [
    createElementVNode("div", _hoisted_1, [
      renderSlot(_ctx.$slots, "header"),
      createElementVNode("div", _hoisted_2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.visibleItems, (item, index) => {
          return (openBlock(), createElementBlock("div", {
            class: "wf-item",
            key: _ctx.itemKey(item, index),
            style: normalizeStyle({ width: item.width + 'px', height: item.height + 'px', top: item.top + 'px', left: item.left + 'px' }),
            role: "listitem"
          }, [
      ...
      (_ctx.loading)
        ...
        : createCommentVNode("v-if", true),
      (_ctx.noMore)
        ? (openBlock(), createElementBlock("div", _hoisted_6, "没有更多"))
        : createCommentVNode("v-if", true)
    ])
  ], 4 /* STYLE */))
}
